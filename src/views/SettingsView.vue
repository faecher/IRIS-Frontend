...
<template>
  <div class="flex flex-col gap-4 p-5 min-w-64">
    ...
    <h1 class="font-bold text-black dark:text-gray-100 text-3xl">
      Einstellungen
    </h1>
    ...
    <div class="bg-gray-200 dark:bg-gray-800 rounded-lg p-4">
      <h2 class="font-bold text-2xl text-black dark:text-gray-300 mb-4">
        MCP Einstellungen
      </h2>

      <div class="flex gap-5 flex-col md:flex-row">
        <div class="flex-1">
          <h3 class="font-bold text-black dark:text-gray-100 text-xl mb-2">
            Verbindung
          </h3>
            ...
            <div class="flex gap-4 items-center">
              ...
              <div class="flex items-center mb-2">
                ...
                <label for="hide-archived-checkbox" class="ms-2 text-sm font-medium text-gray-400">
                  Zeige archivierte Sanitätsdienste an
                </label>
              </div>
            </div>
      ...
      <div class="flex justify-between items-center mb-4">
        ...
        <dialog v-if="showResetConfirm" class="rounded-lg shadow-xl p-4 bg-gray-700 border-gray-600" open>
          <h3 class="text-lg font-semibold mb-4 text-white">
            Willst du wirklich alle Zuweisungen zurücksetzen?
          </h3>
          <div class="flex gap-2 justify-end">
            <button class="px-4 py-2 bg-gray-400 rounded hover:cursor-pointer" @click="showResetConfirm = false">
              Abbrechen
            </button>
            <button class="px-4 py-2 bg-red-500 text-white rounded hover:cursor-pointer" @click="resetTrackers">
              Zurücksetzen
            </button>
          </div>
        </dialog>
    ...
    <div class="bg-gray-200 dark:bg-gray-800 rounded-lg p-4">
      <h2 class="font-bold text-black dark:text-gray-300 text-2xl mb-4">
      ...
      <div>
        <input
          ...
          class="mr-2"
        >
        <label for="show_unassigned" class="text-black dark:text-gray-300">Zeige Tracker auf der Karte an, die nicht mit MCP verknüpft sind</label>
      </div>
      ...
      <div>
        <input
          ...
          class="mr-2"
        >
        <label for="show_inactive" class="text-black dark:text-gray-300">Zeige inaktive Tracker (Tracker im Status 6) auf der Karte an</label>
      </div>
    </div>
    ...
    <div class="bg-gray-200 dark:bg-gray-800 rounded-lg p-4">
      ...
      <div>
        <h3 class="font-bold text-black dark:text-gray-300 text-xl my-4">
          IRIS-Server
        </h3>
