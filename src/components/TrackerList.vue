...
<template>
	<div class="maplibregl-ctrl-top-left">
		<div class="maplibregl-ctrl rounded-sm shadow-lg bg-gray-900 min-w-72">
			...
			<div v-if="showList" class="max-h-[93vh] overflow-y-scroll">
				<div v-for="tracker in connectionStore.trackers.sort((a, b) => a.name.localeCompare(b.name))" :key="tracker.id" class="w-full flex pt-1 pb-1 pl-2 pr-2 hover:bg-gray-700" @click="flyToMarker(tracker)">
					<div>
