...
<template>
  <dialog v-if="showDialog" class="rounded-lg shadow-xl p-6 backdrop:bg-black/50" open>
    ...
    <div class="flex gap-2 justify-end">
      <button class="px-4 py-2 bg-gray-200 rounded hover:cursor-pointer" @click="closeDialog">
        Abbrechen
      </button>
      <button class="px-4 py-2 bg-blue-500 text-white rounded hover:cursor-pointer" @click="saveTrackerName">
        Speichern
      </button>
    </div>
  </dialog>
