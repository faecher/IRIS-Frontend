import type { Event, LngLatLike, PointLike, PositionAnchor } from 'maplibre-gl'
import type { PropType } from 'vue'
import { mapSymbol, markerSymbol } from '@indoorequal/vue-maplibre-gl'
...
export default defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    function emitEvent(
      eventName: 'dragstart' | 'drag' | 'dragend' | 'click',
      additionalCb?: () => void,
    ) {
      const fn = (e: Event) => {
        if (additionalCb)
